...
/// is driven by TabletopKit and translated to world coordinates by the
/// render delegate.
@MainActor
enum BoardSurface {
    ...
    /// World-space position (relative to the board root) of the centre of a `Square`,
